...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="../vendor/assets/css/fontawesome.css">
    <link rel="stylesheet" href="../vendor/assets/css/templatemo-space-dynamic.css">
    <link rel="stylesheet" href="../vendor/assets/css/animated.css">
    <link rel="stylesheet" href="../vendor/assets/css/owl.css">
<!--
...
<body>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="../vendor/assets/images/banner-right-image.png" alt="team meeting">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="left-image wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
            <img src="../vendor/assets/images/about-left-image.png" alt="person graphic">
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                  <div class="icon">
                    <img src="../vendor/assets/images/service-icon-01.png" alt="reporting">
                  </div>
              ...
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.7s">
                  <div class="icon">
                    <img src="../vendor/assets/images/service-icon-02.png" alt="">
                  </div>
                  <div class="right-text">
              ...
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.9s">
                  <div class="icon">
                    <img src="../vendor/assets/images/service-icon-03.png" alt="">
                  </div>
                  <div class="right-text">
                    <h4>Web Analytics</h4>
                    <p>Lorem ipsum dolor sit amet, ctetur aoi adipiscing eliter</p>
              ...
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="1.1s">
                  <div class="icon">
                    <img src="../vendor/assets/images/service-icon-04.png" alt="">
                  </div>
                  <div class="right-text">
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center  wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
          <div class="left-image">
            <img src="../vendor/assets/images/services-left-image.png" alt="">
          </div>
        </div>
          ...
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
              ...
              <div class="showed-content">
                <img src="../vendor/assets/images/portfolio-image.png" alt="">
              </div>
            </div>
          </a>
        </div>
  ...
  <div id="blog" class="our-blog section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.25s">
          <div class="top-dec">
            <img src="../vendor/assets/images/blog-dec.png" alt="">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.25s">
          <div class="left-image">
            <a href="#"><img src="../vendor/assets/images/big-blog-thumb.jpg" alt="Workspace Desktop"></a>
            <div class="info">
            ...
            <ul>
              <li>
                ...
                <div class="right-image">
                  <a href="#"><img src="../vendor/assets/images/blog-thumb-01.jpg" alt=""></a>
                </div>
              </li>
              <li>
                <div class="left-content align-self-center">
        ...
        <div class="col-lg-6 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.25s">
          <form id="contact" action="" method="post">
            ...
            <div class="contact-dec">
              <img src="../vendor/assets/images/contact-decoration.png" alt="">
            </div>
          </form>
        </div>
      </div>
  ...
  <script src="../vendor/assets/js/owl-carousel.js"></script>
  <script src="../vendor/assets/js/animation.js"></script>
  <script src="../vendor/assets/js/imagesloaded.js"></script>
  <script src="../vendor/assets/js/templatemo-custom.js"></script>
